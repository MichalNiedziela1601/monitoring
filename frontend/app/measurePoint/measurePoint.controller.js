...
(function(){
    'use strict';
    function MeasurePointController($routeParams,PunktWodny){
        var ctrl = this;
        ctrl.id = $routeParams.id;
        ctrl.isOpen = false;

        function getOpadInt() {
            // PunktWodny.getOpadInt(ctrl.id).then(function (data) {
            //     ctrl.image = data;
        ...
        function getTableWithDate(){
            PunktWodny.getTableWithDate(ctrl.id, ctrl.pickerBoth.date.getFullYear(),
        ...
        // function getWykresH() {
        //     PunktWodny.getWykresH(ctrl.id).then(function (data) {
        //         ctrl.wykresH = data;
        //     })
        //     .catch(function (error) {
        //         console.log(error);
        ...
        //     PunktWodny.getWykresHwithDate(ctrl.id, ctrl.pickerBoth.date.getFullYear(),
        //             ctrl.pickerBoth.date.getMonth() + 1, ctrl.pickerBoth.date.getUTCDate(),
        //             ctrl.pickerBoth.date.getHours(), ctrl.pickerBoth.date.getMinutes())
        //     .then(function (data) {
        //         ctrl.wykresH = data;
        ...
        //
        // function getWykresD() {
        //     PunktWodny.getWykresD(ctrl.id).then(function (data) {
        //         ctrl.wykresD = data;
        //     })
        //     .catch(function (error) {
        //         console.log(error);
        ...
        //     PunktWodny.getWykresDwithDate(ctrl.id, ctrl.pickerBoth.date.getFullYear(),
        //             ctrl.pickerBoth.date.getMonth() + 1, ctrl.pickerBoth.date.getUTCDate(),
        //             ctrl.pickerBoth.date.getHours(), ctrl.pickerBoth.date.getMinutes())
        //     .then(function (data) {
        //         ctrl.wykresD = data;
